...
namespace Demo
{
    ...
    /// </code>
    /// </example>
    public partial class @HelicopterInput: IInputActionCollection2, IDisposable
    {
        /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Helicopter"",
            ""id"": ""7aceaca3-2518-4214-a049-b08edc2d296c"",
            ""actions"": [
                {
                    ""name"": ""HorizontalRotation"",
                    ""type"": ""Value"",
                    ""id"": ""7db6fe55-196d-4162-8f26-f74d923b3a27"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""HeightAxis"",
                    ""type"": ""Value"",
                    ""id"": ""fdd259c6-2918-42ed-bd86-02292c718b52"",
                ...
                },
                {
                    ...
                    ""type"": ""Value"",
                    ""id"": ""790dd0a8-5e83-4dbb-9bdb-89392df2eb91"",
            ...
            ""bindings"": [
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""8f2bd1df-d4a0-4972-84c6-7fad2db1e748"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""ad70deef-e393-4e83-8552-400b4886a816"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""5424c7c0-de1c-42d5-84b7-b4be651253cd"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""461c2d14-e078-48ce-8c52-516b00a09626"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""2d98ff48-7e28-43a9-8ac3-2adbb08b2ee3"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""a670d5db-a39c-4536-8cea-00e754db5c7e"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""d641001b-b0dc-4363-b5a0-7d58e9dab0b2"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""78186a75-dfb2-4cb6-a99c-d430eb56afa6"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_Helicopter_HorizontalRotation = m_Helicopter.FindAction("HorizontalRotation", throwIfNotFound: true);
            m_Helicopter_HeightAxis = m_Helicopter.FindAction("HeightAxis", throwIfNotFound: true);
            m_Helicopter_HorizontalMovement = m_Helicopter.FindAction("HorizontalMovement", throwIfNotFound: true);
        }

        ~@HelicopterInput()
        {
            UnityEngine.Debug.Assert(!m_Helicopter.enabled, "This will cause a leak and performance issues, HelicopterInput.Helicopter.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_Helicopter_HorizontalRotation;
        private readonly InputAction m_Helicopter_HeightAxis;
        private readonly InputAction m_Helicopter_HorizontalMovement;
        /// <summary>
        /// Provides access to input actions defined in input action map "Helicopter".
        /// </summary>
        public struct HelicopterActions
        {
            private @HelicopterInput m_Wrapper;

            /// <summary>
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public HelicopterActions(@HelicopterInput wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "Helicopter/HorizontalRotation".
            /// </summary>
            public InputAction @HorizontalRotation => m_Wrapper.m_Helicopter_HorizontalRotation;
            /// <summary>
            /// Provides access to the underlying input action "Helicopter/HeightAxis".
            /// </summary>
            public InputAction @HeightAxis => m_Wrapper.m_Helicopter_HeightAxis;
            /// <summary>
            /// Provides access to the underlying input action "Helicopter/HorizontalMovement".
            /// </summary>
            public InputAction @HorizontalMovement => m_Wrapper.m_Helicopter_HorizontalMovement;
            /// <summary>
            ...
            public void AddCallbacks(IHelicopterActions instance)
            {
                ...
                @HeightAxis.started += instance.OnHeightAxis;
                @HeightAxis.performed += instance.OnHeightAxis;
                @HeightAxis.canceled += instance.OnHeightAxis;
        ...
        {
            /// <summary>
            /// Method invoked when associated input action "HorizontalRotation" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
            /// </summary>
            ...
            /// <summary>
            /// Method invoked when associated input action "HeightAxis" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
            /// </summary>
            /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
            void OnHeightAxis(InputAction.CallbackContext context);
            /// <summary>
